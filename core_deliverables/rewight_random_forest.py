...
print(f"Random Forest (reweighted) | Accuracy: {overall_acc:.3f} | AUC: {overall_auc:.3f}")
...
log_summary_row(
    model_name="random_forest_reweighted",
...
# Visualizations for reweighted Random Forest
