...
proba_post = xgb.predict_proba(X_test)[:, 1]
...
save_results_visualization('xgboost_postprocess', y_test, pred_post, proba_post, sensitive_features_dict={"gender": g_test, "race": r_test})

log_summary_row('xgboost_postprocess', overall_acc, overall_auc, dp_gender, eo_gender, dp_race, eo_race, '/content/model_results.csv')